...
from .models import UserAdressMdel , UserBankAccountModel
...
class UserUpdateForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            user_address, created = UserAdressMdel.objects.get_or_create(user=user) 
